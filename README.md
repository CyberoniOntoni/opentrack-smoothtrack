...
- Tobii eye tracker
- SmoothTrack Head Tracker (iOS/Android)<sup>[[1](https://smoothtrack.app/)]</sup> — Wi‑Fi via “UDP over network”; iOS USB via “SmoothTrack iOS (USB)” when built with libusbmuxd
